...
- **Enforced-clean set** — must stay simultaneously ruff-, black-, and `--strict`-clean; `scripts/check.sh` fails on any new error here:
  `core/models.py`, `core/strategy.py`, `core/backtest/`, `core/analysis/`, `core/agents/strategy_lab_agent.py`, `core/agents/backtest_harness.py`, `core/agents/backtest_agent.py`, `core/agents/critic_agent.py`, `core/broker.py`, `core/config.py`, `core/usage_accounting.py`.
